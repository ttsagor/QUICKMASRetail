...
import com.quickmas.salim.quickmasretail.Module.RTM.MI.MIList.Adaptar_crm_product_list;
...
public class MiList extends AppCompatActivity {
    DBInitialization db;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headtext.setText(DashboardSubMenu.getMenuText(db, "rtm_activity_list_5"));
        ...
        ArrayList<MIInvoiceHead> invoices = MIInvoiceHead.select(db,db.COLUMN_crm_Invoice_head_status+"!=0");
        ...
        sell_invoice_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MiList.this,MainActivity.class);
