...
public class Adaptar_invoice_company extends BaseAdapter implements ListAdapter {
    private Context context;
    LayoutInflater inflater;
    ArrayList<Company> allCompany = new ArrayList<Company>();
    boolean editButtonFlag;
    public Adaptar_invoice_company(Context context,ArrayList<Company> allCompany,boolean editButtonFlag) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Adaptar_invoice_company.rowHolder holder = new Adaptar_invoice_company.rowHolder();
        if (view == null) {
        ...
        {
            holder = (Adaptar_invoice_company.rowHolder) view.getTag();
        }
        ...
        Adaptar_invoice_company_product adapter = new Adaptar_invoice_company_product(context, allCompany.get(position).getGifts(),editButtonFlag);
