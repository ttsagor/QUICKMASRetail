...
import com.quickmas.salim.quickmasretail.Module.RTM.MI.MISale.Adaptar_crm_outlet_select_company;
...
public class MiSale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headtext.setText(DashboardSubMenu.getMenuText(db, "rtm_activity_5"));
        ...
        sell_dashboardSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                Adaptar_crm_outlet_select_company adapter = new Adaptar_crm_outlet_select_company(getApplicationContext(), companies, invoiceOutlet);
