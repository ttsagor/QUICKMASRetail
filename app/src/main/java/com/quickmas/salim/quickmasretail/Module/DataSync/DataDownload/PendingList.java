...
public class PendingList extends AppCompatActivity {
    ...
    Context context;
    public static ArrayList<Product> pendingProductList = new ArrayList<Product>();
    public static boolean dataDownloadableStatus =false;
    DBInitialization db;
    ListView acceptData_list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button acceptData_accept_button = setTextFont((Button) findViewById(R.id.acceptData_accept_button), this, db, "acceptData_acceptButton");
        ArrayList<Company> allCompany = getCompanyStructOnlyProductAndGift(pendingProductList);


        acceptData_list = (ListView) findViewById(R.id.acceptData_list);
       ...
       // UIComponent.updateListViewHeight(acceptData_list,1);
        ...
        try {
            ...
            //String q = getText(R.string.acceptData_product) + String.valueOf(Company.getSkuCountCompany(allCompany, "PRODUCT")) + " " + getText(R.string.acceptData_and) + " " + getText(R.string.acceptData_gift) + String.valueOf(Company.getSkuCountCompany(allCompany, "GIFT") + " " + "Free Product: " + String.valueOf(Company.getSkuCountCompany(allCompany, "FREE")));
            //acceptData_qantity.setText(q);
        }catch (Exception e){}
        ...
        {
            acceptData_accept_button.setVisibility(View.VISIBLE);
        }
        else
        {
            acceptData_accept_button.setVisibility(View.GONE);
        }
        acceptData_accept_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PendingList.this, Dataloading.class);
