...
public class DeliverStock extends AppCompatActivity {
                                    ...
                                    new Thread(new Runnable() {
                                        public void run() {
                                            for (StockTransferDetails ns : newStock)
                                            {
                                                ...
                                                stockTransferDetails.setDelivered_qty(stockTransferDetails.getDelivered_qty() + ns.getDelivered_qty());
                                                if(stockTransferDetails.getDelivered_qty()>=stockTransferDetails.getQuantity())
                                                {
    ...
    {
        hideSoftKeyboard(DeliverStock.this);
    ...
    public void dataShow(final ViewData data)
    {
        ...
        FontSettings.setTextFont((TextView) data.view.findViewById(R.id.product_quantity),mContext,String.valueOf(posInvoice.getQuantity()- posInvoice.getDelivered_qty()));
        ...
        for(int i=0;i<=posInvoice.getQuantity()- posInvoice.getDelivered_qty();i++)
        {
        ...
        exchange_quantity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                posInvoice.setDelivered_qty(position);
