...
public class SaleOutletSelection extends AppCompatActivity {
        ...
        sell_dashboardSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                for(Product cProuct : products)
                {
                    ...
                    DebugHelper.print(cProuct);
                }
                ArrayList<Company> companies =  getCompanyStruct(tempProducts);
                Adaptar_sell_dashboard_company adapter = new Adaptar_sell_dashboard_company(getApplicationContext(), companies, invoiceOutlet);
