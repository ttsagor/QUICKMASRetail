...
public class FreeProductSaleList extends AppCompatActivity {
    DBInitialization db;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<FreeProductInvoiceHead> invoices = FreeProductInvoiceHead.select(db,db.COLUMN_free_Invoice_head_status+"!=0");
        int totalCount = invoices.size();
        int totalQuantity=0;
        for (FreeProductInvoiceHead memo : invoices)
        {
            totalQuantity+= memo.getProduct_quantity();
        }
        ...
        final TextView amount_total = setTextFont((TextView) footer.findViewById(R.id.amount_total),this,String.valueOf(totalQuantity));

        Adaptar_free_product_list adapter = new Adaptar_free_product_list(getApplicationContext(), invoices);
        ...
        sell_invoice_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FreeProductSaleList.this,MainActivity.class);
