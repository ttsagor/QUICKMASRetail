...
public class PosInvoiceCombianRegular {
    public int id;
    ...
    public static ArrayList<PosInvoiceCombianRegular> setPosInvoiceCombian(ArrayList<PosInvoiceRegular> posInvoices)
    {
        ArrayList<PosInvoiceCombianRegular> posInvoiceCombians = new ArrayList<>();
        for(PosInvoiceRegular posInvoice : posInvoices)
        {
            PosInvoiceCombianRegular combian = new PosInvoiceCombianRegular();
    ...
    public static ArrayList<PosInvoiceCombianRegular> setPosInvoiceCombianWeb(ArrayList<PosInvoiceRegularWeb> posInvoices)
    {
        ArrayList<PosInvoiceCombianRegular> posInvoiceCombians = new ArrayList<>();
        for(PosInvoiceRegularWeb posInvoice : posInvoices)
        {
            PosInvoiceCombianRegular combian = new PosInvoiceCombianRegular();
            combian.id=posInvoice.id;
            combian.invoiceID=posInvoice.invoiceID;
