...
public class Adaptar_crm_product_list extends BaseAdapter implements ListAdapter {
    ...
    TextView mText;
    int stats;
    ArrayList<MIInvoiceHead> allProduct = new ArrayList<MIInvoiceHead>();
    DBInitialization db;
    public Adaptar_crm_product_list(Context context, ArrayList<MIInvoiceHead> allProduct) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final MIInvoiceHead invoiceHead = allProduct.get(position);
        ...
        holder.action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                print.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent( context ,MiPrint.class);
    ...
    void imagepopup(MIInvoiceHead freeProductInvoiceHead,final Button btn)
    {
        ...
        for(String img : images)
        {
            ...
            imageview.setImageURI(Uri.parse(Environment.getExternalStorageDirectory().toString() + "/" + FileManagerSetting.folder_name + "/" + FileManagerSetting.rtm_mi_product + "/" + img.trim()));
