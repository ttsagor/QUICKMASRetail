...
public class PosInvoiceHeadCombian {
    public int id;
    ...
    public static ArrayList<PosInvoiceHeadCombian> getPosInvoiceCombianInvoice(ArrayList<PosInvoiceHead> posInvoiceHeads)
    {
        ArrayList<PosInvoiceHeadCombian> combians = setPosInvoiceHead(posInvoiceHeads);
        return sortDateWise(combians);
    }

    public static ArrayList<PosInvoiceHeadCombian> getPosInvoiceCombianInvoiceWeb(ArrayList<PosInvoiceHeadWeb> posInvoiceHeadWebs)
    {
        ArrayList<PosInvoiceHeadCombian> combians = setPosInvoiceHeadWeb(posInvoiceHeadWebs);
        return sortDateWise(combians);
    }
    public static ArrayList<PosInvoiceHeadCombian> getPosInvoiceCombian(ArrayList<PosInvoiceHead> posInvoiceHeads,ArrayList<PosInvoiceHeadWeb> posInvoiceHeadWebs)
    {
        ArrayList<PosInvoiceHeadCombian> combians = setPosInvoiceHead(posInvoiceHeads);
    ...
    public static ArrayList<PosInvoiceHeadCombian> sortDateWise(ArrayList<PosInvoiceHeadCombian> posInvoiceHeadCombians)
    {
        ArrayList<String> dates =new ArrayList<>();
        ArrayList<PosInvoiceHeadCombian> posInvoiceHeadCombianArrayList =new ArrayList<>();
        for(PosInvoiceHeadCombian posInvoiceHeadCombian : posInvoiceHeadCombians)
        {
    ...
    public static ArrayList<PosInvoiceHeadCombian> getInvoiceByDate(ArrayList<PosInvoiceHeadCombian> combians, String date)
    {
        ArrayList<PosInvoiceHeadCombian> posInvoiceHeadCombians = new ArrayList<>();
        for(PosInvoiceHeadCombian posInvoiceHeadCombian : combians)
        {
    ...
    public static ArrayList<PosInvoiceHeadCombian> setPosInvoiceHead(ArrayList<PosInvoiceHead> posInvoiceHeads)
    {
        ArrayList<PosInvoiceHeadCombian> posInvoiceHeadCombians = new ArrayList<>();
        for(PosInvoiceHead invoiceHead : posInvoiceHeads)
        {
            PosInvoiceHeadCombian combian = new PosInvoiceHeadCombian();
    ...
    public static ArrayList<PosInvoiceHeadCombian> setPosInvoiceHeadWeb(ArrayList<PosInvoiceHeadWeb> posInvoiceHeads)
    {
        ArrayList<PosInvoiceHeadCombian> posInvoiceHeadCombians = new ArrayList<>();
        for(PosInvoiceHeadWeb invoiceHead : posInvoiceHeads)
        {
            PosInvoiceHeadCombian combian = new PosInvoiceHeadCombian();
            combian.id = invoiceHead.id;
            combian.invoice_id=invoiceHead.invoice_id;
