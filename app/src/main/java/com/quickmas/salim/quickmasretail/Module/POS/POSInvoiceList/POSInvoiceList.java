...
public class POSInvoiceList extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    DBInitialization db;
    ListView memo_list;
    Context context;
    ...
    void updateListview()
    {
        ...
        ScrollListView.loadListView(context,memo_list,R.layout.pos_invoice_list_iteam, PosInvoiceHeadCombian.getPosInvoiceCombian(invoices,posInvoiceHeadWebs),"invoiceList",0,200,true);

    }

    public void invoiceList(ViewData data)
    {
        final PosInvoiceHeadCombian posInvoiceHead = (PosInvoiceHeadCombian) data.object;
        ...
        action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                payment.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        popupWindow.dismiss();
                        Intent i = new Intent(context, InvoicePayment.class);
                        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        i.putExtra("id", String.valueOf(posInvoiceHead.getId()));
                        i.putExtra("category", String.valueOf(posInvoiceHead.getCategory()));
                ...
                print.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        popupWindow.dismiss();
                        Intent i = new Intent(context, PosInvoicePrint.class);
                        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        i.putExtra("id", String.valueOf(posInvoiceHead.getId()));
                        i.putExtra("category", String.valueOf(posInvoiceHead.getCategory()));
                        context.startActivity(i);
    ...
    void showDate(int year, int monthOfYear, int dayOfMonth, int spinnerTheme) {
        new SpinnerDatePickerDialogBuilder()
                .context(POSInvoiceList.this)
                .callback(POSInvoiceList.this)
