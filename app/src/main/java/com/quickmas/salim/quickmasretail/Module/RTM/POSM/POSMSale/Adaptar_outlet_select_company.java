...
public class Adaptar_outlet_select_company extends BaseAdapter implements ListAdapter {
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        final ArrayList<Product> products = allCompany.get(position).getPosm();
        ...
        if(allCompany.get(position).getGifts().size()>0) {
            ...
            for (int i = 0; i < lim; i++) {
                ...
                if (products.size() > cproduct1) {
                    ...
                    final TextView sku1 = FontSettings.setTextFont((TextView) footer.findViewById(R.id.sku1),context,"");
                ...
                if (products.size() > cproduct2) {
                    ...
                    final TextView sku2 = FontSettings.setTextFont((TextView) footer.findViewById(R.id.sku2),context,"");
    ...
    void showProductDetails(final Product product,final TextView skuView)
    {
        ...
        ArrayList<POSMInvoice> cProduct = POSMInvoice.select(db,db.COLUMN_posm_Invoice_product_id+"="+product.getId()+" AND "+db.COLUMN_posm_Invoice_status+"=0");
        ...
        final View popupView = layoutInflater.inflate(R.layout.pop_up_posm_product_outlet_product_select, null);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int invoice_id =1;
                ArrayList<POSMInvoiceHead> pendingId = POSMInvoiceHead.getPendingInvoices(db);
                if(pendingId.size()>0)
                {
                ...
                {
                    invoice_id = POSMInvoiceHead.getMaxInvoice(db)+1;
                    POSMInvoiceHead freeProductInvoiceHead = new POSMInvoiceHead();
                    freeProductInvoiceHead.setId(invoice_id);
                    freeProductInvoiceHead.setOutlet(invoiceOutlet);
                ...
                POSMInvoice freeProductInvoice = new POSMInvoice();
               ...
               Intent i = new Intent(context, PosmCurrentInvoice.class);
