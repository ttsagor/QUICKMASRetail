...
import com.quickmas.salim.quickmasretail.Module.RTM.POSM.POSMSale.Adaptar_outlet_select_company;
...
public class PosmProductSelect extends AppCompatActivity {
    String invoiceOutlet="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        //super.onCreate(savedInstanceState);
        //setContentView(R.layout.activity_posm_product_select);
