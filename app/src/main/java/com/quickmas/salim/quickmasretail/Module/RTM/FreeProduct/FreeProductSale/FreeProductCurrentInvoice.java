...
public class FreeProductCurrentInvoice extends AppCompatActivity {
    DBInitialization db;
    int amountCount=0;
    int uPriceCount=0;
    ...
    ArrayList<FreeProductInvoice> invoices = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invoices = FreeProductInvoice.getPendingInvoices(db);



        cOutlet = Outlet.select(db,db.COLUMN_o_id+"="+invoices.get(0).getOutlet_id()).get(0);
        ...
        for(FreeProductInvoice cInvoice : invoices)
        {
        ...
        ArrayList<Company> allCompany = Company.getCompanyStructOnlyFreeProduct(products);

        Adaptar_invoice_company adapter = new Adaptar_invoice_company(getApplicationContext(), allCompany,true);
       ...
       // total_closing= setTextFont(total_closing,this,String.valueOf(totalPriceCount));
        ...
        sell_invoice_add_new.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent( FreeProductCurrentInvoice.this ,FreeProductSelection.class);
                    ...
                    public void onClick(final DialogInterface dialog, int which) {
                        switch (which){
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                final ProgressDialog progressDoalog = new ProgressDialog(FreeProductCurrentInvoice.this);
                                    ...
                                    public void run() {
                                        ...
                                        sell_invoice_date.post(new Runnable() {
                                            public void run() {
                                                ...
                                                Intent intent = new Intent(FreeProductCurrentInvoice.this,FreeProductSaleList.class);
        ...
        sell_invoice_discard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(FreeProductCurrentInvoice.this);
                ...
                builder.setPositiveButton(textSelectByVarname(db,"sellInvoice_sell_invoice_dialog_yes").getText(), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        FreeProductInvoice.deletePendingInvoices(db);
                        FreeProductInvoiceHead.deletePendingInvoices(db);
                        Intent intent = new Intent(FreeProductCurrentInvoice.this,MainActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(intent);
                        dialog.dismiss();
                        finish();
        ...
        if(invoices.size()>0)
        {
            ...
            for (int i = 0; i < image_list.size(); i++) {
                try
                {
                    ...
                    String root = Environment.getExternalStorageDirectory().toString() + "/" + FileManagerSetting.folder_name + "/" + FileManagerSetting.rtm_free_product + "/" + fileName;
            ...
            int quantity = 0;
            for(FreeProductInvoice invoice : invoices)
            {
            ...
            FreeProductInvoiceHead invoiceHead = FreeProductInvoiceHead.getPendingInvoices(db).get(0);
            ...
            invoiceHead.setProduct_quantity(quantity);
