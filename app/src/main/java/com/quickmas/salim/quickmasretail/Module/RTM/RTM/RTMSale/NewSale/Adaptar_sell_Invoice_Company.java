...
public class Adaptar_sell_Invoice_Company extends BaseAdapter implements ListAdapter {
    private Context context;
    LayoutInflater inflater;
    ArrayList<Company> allCompany = new ArrayList<Company>();
    boolean editButtonFlag;
    public Adaptar_sell_Invoice_Company(Context context,ArrayList<Company> allCompany,boolean editButtonFlag) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Adaptar_Sell_Invoice_Company_Product adapter = new Adaptar_Sell_Invoice_Company_Product(context, allCompany.get(position).getProductAndGift(),editButtonFlag);
